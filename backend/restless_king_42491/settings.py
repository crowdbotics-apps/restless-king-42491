"""
Django settings for restless_king_42491 project.
...
ROOT_URLCONF = 'restless_king_42491.urls'
...
WSGI_APPLICATION = 'restless_king_42491.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_king_42491 API",
    "DESCRIPTION": "API documentation for restless_king_42491 App",
    "VERSION": "v1",
}
